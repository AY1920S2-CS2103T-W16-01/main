...
BBProductive is a gamified productivity app cum task manager. It provides CRUD functionalities for tasks and offers a built-in Pomodoro that keeps a user focused on work for fixed intervals. BBProductive also offers a virtual pet that grows along with the user's productivity.
...
** What it does: Generates data for the user to view in the statistics tab. Firstly, it displays the Daily Challenge, which tracks the total time the user ran the Pomodoro on the current day in an aesthetic progress bar. Secondly, it contains 2 bar graphs that tracks the number of tasks done and total duration the Pomodoro was run for the past 7 days.
...
*** Morphed the basic GUI layout from addressbook to BBProductive by implementing PetDisplay, PomodoroDisplay and StatisticsDisplay. Relevant PRs: [https://github.com/AY1920S2-CS2103T-W16-1/main/pull/84[#84]] [https://github.com/AY1920S2-CS2103T-W16-1/main/pull/88[#88]] [https://github.com/AY1920S2-CS2103T-W16-1/main/pull/90[#90] [https://github.com/AY1920S2-CS2103T-W16-1/main/pull/120[#120]]
...
** Documentation:
*** Updated documentation for UI, Statistics, User Stories and Non-Functional Requirements in Developer Guide.
*** Updated documentation for GUI and Statistics and Storage in User Guide.
** Community:
